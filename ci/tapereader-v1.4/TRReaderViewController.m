...
- (BOOL)isStudyMode { return !self.reviewing && _modes && _modes.selectedSegmentIndex == 0; }
- (void)viewDidLoad {
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    if (!self.reviewing && _modes) self.navigationItem.titleView = _modes;
...
- (void)updatePageLabel {
    if ([self isEditingMode] && self.document.tapes.count == 0)
